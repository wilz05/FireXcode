...
extension StfulStless on Widget {
  Widget xMaterialApp({
    ...
    return MaterialApp(
      home: this,
      builder: builder as Widget Function(BuildContext, Widget?)?,
      checkerboardOffscreenLayers: checkerboardOffscreenLayers,
      key: key,
      locale: locale,
      localeListResolutionCallback: localeListResolutionCallback as Locale? Function(List<Locale>?, Iterable<Locale>)?,
      localeResolutionCallback: localeResolutionCallback as Locale? Function(Locale?, Iterable<Locale>)?,
